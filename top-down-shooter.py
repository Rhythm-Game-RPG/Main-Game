...
# Must initialize pygame to do anything in it
pygame.init()

# Creating the window
screen = pygame.display.set_mode((WIDTH, HEIGHT))
# Name of the program in the top left
pygame.display.set_caption("Top Down Shooter")
# Clock method is for fps
...
class Player(pygame.sprite.Sprite):
    # Creating the constructor, called __init__
    def __init__(self):
        super().__init__()
...
# Actual running game
while True:
    # This takes in any key pressed as an event, and lets us do stuff with them
    keys = pygame.key.get_pressed()
    for event in pygame.event.get():
        # Must close the window AND program with exit()
